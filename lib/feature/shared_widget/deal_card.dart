...
///
/// Only flash-sale deals carry any per-second reactivity (the countdown
/// badge below), scoped to that badge alone — a plain (non-flash) card
/// never rebuilds on the countdown tick at all, which matters with 100+
/// cards live in the feed at once.
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                AppConfig.primaryGreen.withValues(alpha: 0.12),
